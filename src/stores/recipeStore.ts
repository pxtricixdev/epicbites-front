...
export const useRecipeStore = defineStore('recipes', () => {
  ...
  const fetchAllRecipes = async () => {
    ...
    try {
      const response = await fetch('https://epicbitesapi.retocsv.es/api/recetas/all', {
        method: 'GET',
        headers: {
  ...
  const fetchRecipeDetail = async (id: string | number) => {
    ...
    try {
      const response = await fetch(`https://epicbitesapi.retocsv.es/api/recetas/${id}`, {
        method: 'GET',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
  ...
  const fetchMostRatedRecipes = async () => {
    ...
    try {
      const response = await fetch('https://epicbitesapi.retocsv.es/api/recetas/most-rated', {
        method: 'GET',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
  ...
  const createRecipe = async (recipeData: IPostRecipe, imageFile: File) => {
    ...
    try {
      ...
      const response = await fetch('https://epicbitesapi.retocsv.es/api/recetas', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
        },
  ...
  const fetchRecipeByUser = async () => {
    ...
    try {
      const response = await fetch(`https://epicbitesapi.retocsv.es/api/recetas/user/${userId}`, {
        method: 'GET',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',

...
export const useReviewStore = defineStore('reviews', () => {
  ...
  const fetchAllReviews = async () => {
    ...
    try {
      const response = await fetch('https://epicbitesapi.retocsv.es/api/comentarios', {
        method: 'GET',
        headers: {
  ...
  const fetchReviewsByRecipe = async (recipeId: string | number) => {
    ...
    try {
      const response = await fetch(`https://epicbitesapi.retocsv.es/api/comentarios/receta/${recipeId}`, {
        method: 'GET',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
  ...
  const deleteReview = async (id: number) => {
    ...
    try {
      const response = await fetch(`https://epicbitesapi.retocsv.es/api/comentarios/${id}`, {
        method: 'DELETE',
        headers: {
          accept: 'application/json',
          'Content-Type': 'application/json',
